...
function M.deep_compare(t1, t2, ignore_mt)
  ...
  for k1, v1 in pairs(t1) do
    local v2 = t2[k1]
    if v2 == nil or not M.deep_compare(v1, v2) then
      return false
    end
  end
...
M.size = _ENV.table_size or _size
...
function M.array_to_dictionary(tbl, as_bool)
  local newtbl = {}
...
function M.unique_values(tbl)
  return M.keys(M.invert(tbl))
end
